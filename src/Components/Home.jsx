...
export function Home() {
    return (
        <section className="  h-3/6 lg:flex ">
            <div className=" ">
            ...
            <div className="  w-1/2 flex items-center mr-40 relative" >
                ...
                <img className="rounded-lg cursor-pointer shadow-lg shadow-black object-contain w-80 hidden absolute  bottom-20 z-20 -right-32   lg:block" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcThgaXKw4_lwPhnPNSQu-sW7T437vvVI62VVw&s" alt="" />
