...
export function Header() {
    ...
    return (
        <header className={`w-full h-10 lg:h-11 z-50 transition-transform duration-300       fixed    align-baseline justify-between flex ${isHidden ? "-translate-y-full" : 'translate-y-5'}`}>
            <img className="w-10 h-10 text-neutral-50 dark:text-neutral-600 border-neutral-50/50 p-1 border bg-zinc-800 ml-4 lg:ml-28 rounded-full dark:bg-neutral-50  dark:border-neutral-300/50 dark:border" src={imagem} alt="" />
